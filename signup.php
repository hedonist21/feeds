...
<form name="signup" id="signup" method="post" action="signup.php" >
          <table width="345" height="473" border="0" bgcolor="#B1B6BF">
                ...
                <td colspan="3"><input name="first_name" type="text" id="first_name" size="25" /></td>
                <td width="6">&nbsp;</td>
              </tr>
                <tr>
                  <td>&nbsp;</td>
                <td><strong>Last Name</strong></td>
                <td colspan="3"><input name="last_name" type="text" id="last_name" size="25" /></td>
                <td>&nbsp;</td>
              </tr>
                <tr>
                  <td>&nbsp;</td>
			   ...
			   for($y=1910;$y<=2009;$y++)
                ...
                <td colspan="3"><input name="username" type="text" id="username" size="25" /></td>
                <td>&nbsp;</td>
              </tr>
                <tr>
                  <td>&nbsp;</td>
                <td><strong>Password</strong></td>
                <td colspan="3"><input name="password" type="password" id="password" size="25" /></td>
                <td>&nbsp;</td>
              </tr>
                <tr>
                  <td height="29" align="center">&nbsp;</td>
                <td align="left"><strong>Confirm password</strong></td>
                <td colspan="3" align="left"><input name="cpassword" type="password" id="cpassword" size="25" /></td>
                <td align="center">&nbsp;</td>
              </tr>
                <tr>
         ...
         <!-- end category list ----------------------------------------- -->         
             ...
             <div id="Toolbar">
                ...
                <td colspan="3" align="center"><input name="email" type="text" id="email" size="25" /></td>
                <td align="center">&nbsp;</td>
              </tr>
                <tr>
                  <td height="36" align="center">&nbsp;</td>
